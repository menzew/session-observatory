...
The [privacy document](../PRIVACY.md) defines the data boundary. The [user guide](guide.md) defines accounting and import behavior. [Research proposals](research.md) describe possible future integrations, not shipped capabilities.
