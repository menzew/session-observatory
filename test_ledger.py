...
from ledger import Ledger, dump, now, usage, bounded_lines
from server import make_server, loopback_authority
...
class AccountingTests(unittest.TestCase):
    ...
    def test_windows_unavailable_path_and_explicit_server_mapping(self):
        ...
        with patch('ledger.Path.is_dir',return_value=False):
            self.ledger.scan()
    ...
    def test_windows_mount_resolution_and_unc_are_explicit(self):
        ...
        with patch('ledger.Path.is_dir',return_value=True):
